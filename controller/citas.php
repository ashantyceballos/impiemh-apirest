<?php
    ...
    switch($_GET["opcion"]){
        ...
        case "insert":
            ...
            $datos = $cita -> insert_cita($body["dia"],$body["hora"],$body["tipo"],$body["psicologa"],$body["nombrep"],$body["apellidopp"],$body["apellidomp"],$body["id_paciente"]);
        ...
        case "update":
            ...
            $datos = $cita -> update_cita($body["dia"],$body["hora"],$body["tipo"],$body["psicologa"],$body["nombrep"],$body["apellidopp"],$body["apellidomp"],$body["id_paciente"]);
